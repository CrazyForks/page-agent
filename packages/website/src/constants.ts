...
export const CDN_DEMO_URL =
	'https://cdn.jsdelivr.net/npm/page-agent@1.8.0-beta.0/dist/iife/page-agent.demo.js'
export const CDN_DEMO_CN_URL =
	'https://registry.npmmirror.com/page-agent/1.8.0-beta.0/files/dist/iife/page-agent.demo.js'
